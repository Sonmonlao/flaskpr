...
def GETPOST_Users():
    ...
    if request.method == 'POST':
        ...
        if name and email and password and group and position and amounttask and coefficient and salary:
    ...
    if request.method == 'POST':
        ...
        if data:
            if 'name' in data:
                ...
                return 'Не указано название трека', 400
            if 'group' in data:
                group = data['group']
            else:
                return 'Не указана группа', 400
            if 'performers' in data:
                ...
                return 'Не указаны исполнители', 400
            if 'album' in data:
                album = data['album']
            else:
                return 'Не указана группа', 400
        ...
        if name and group and performers and album:
